...
export default function TentangInstansi({ user }) {
    ...
    <nav className="w-full flex justify-center mt-10 z-50 sticky top-0 left-0 bg-transparent">
      ...
      >
        ...
        <ul className="hidden md:flex items-center gap-6 font-medium relative">
          <h2 className="text-2xl font-bold text-emerald-700">Tentang "Nama Instansi"</h2>
        </ul>
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className="absolute right-0 mt-2 w-44 bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden z-50"
              >
          ...
          >
            <ul className="flex flex-col gap-1 p-4">
              ...
              <button
                ...
                className="block text-left w-full px-4 py-2 rounded-lg text-red-600 hover:bg-red-50 font-medium transition-colors"
              >
                Logout
              </button>
            </ul>
