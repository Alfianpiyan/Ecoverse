...
export default function AcarahHijau() {
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {events.map((event) => (
                  ...
                  >
                    <Link
                      href={`/donatur/acara/${event.id}`}
                      className={`w-64 md:w-72 rounded-2xl px-5 py-4 shadow-md flex justify-between items-center transition-all duration-200 hover:shadow-lg cursor-pointer ${
                        event.active
                          ? "bg-[#059669] text-white hover:bg-[#047857]"
                          : "bg-[#B7E4C7] text-[#064E3B] hover:bg-[#A7D7B8]"
                      }`}
                    >
                      <div>
